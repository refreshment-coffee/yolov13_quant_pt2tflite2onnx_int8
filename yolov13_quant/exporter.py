...
class Exporter:
    ...
    def get_int8_calibration_dataloader(self, prefix=""):
        ...
        self.args.data=r"/home/siyingzhen/project_dlchj/datasets/dlchj1/dlchj.yaml"
        ...
        if n > 50:
            from torch.utils.data import Subset  ##使用pytorch的官方获取下标方式

            print("n > 50 .... The calibration dataset selects 50 images for INT8 calibration")
    ...
    def export_onnx(self, prefix=colorstr("ONNX:")):
        ...
        # f2=r"/home/siyingzhen/yolov13_test/yolov13/quant/1208/best10_2.onnx"
        # print(self.metadata)
        # exit()
    ...
    def export_saved_model(self, prefix=colorstr("TensorFlow SavedModel:")):
        ...
        if self.args.int8:
            ...
            # tmp_file=f/"calibration_images_1280.npy"
            if self.args.data:
        ...
        keras_model = onnx2tf.convert(
            ...
            enable_batchmatmul_unfold=False,  # for end-to-end model compatibility
            # output_names=["output_0", "output_1", "output_2"]  
            # param_replacement_file=r"/home/siyingzhen/yolov13_test/yolov13/quant/codes/param_replacement.json",
            # parameter_replacement=parameter_replacement  # <-- 新加的参数
        )
        # yaml_save(f / "metadata.yaml", self.metadata)  # add metadata.yaml
    ...
    def _add_tflite_metadata(self, file):
        ...
        # ---------------------------------------------------------
        # 5. Output Tensor metadata（关键：动态生成）
        # ---------------------------------------------------------
        # output_metas = []

        # for i, out in enumerate(output_details):
            # out_meta = schema.TensorMetadataT()
            # out_meta.name = out.get("name", f"output{i}")
            # out_meta.description = (
                # "Detection output tensor"
                # if self.model.task == "detect"
                # else "Segmentation output tensor"
            # )
            # out_meta.associatedFiles = [label_file]
            # output_metas.append(out_meta)
        ...
        populator.populate()
        tmp_file.unlink()
        print("finish add tflite metadata")
    def _add_tflite_metadata_save(self, file):
        """Add metadata to *.tflite models per https://www.tensorflow.org/lite/models/convert/metadata."""
        import flatbuffers
